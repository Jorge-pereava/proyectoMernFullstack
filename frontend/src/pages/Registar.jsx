...
const Registar = () => {
  ...
  const handleSubmit = async e =>{
    ...
    try {
      ...
      const {data} = await axios.post( url, {name, password, email}) //Obtengo el data para poder ver directamente la información que viene desde la data y no información que no requiero
      //console.log(data)
      setAlerta({
        msg: data.msg,
        error:false
